      ...
      <div className="container mx-auto px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg mb-8">
            Descubre gameplay exclusivo, reviews rápidos y las últimas novedades del mundo gaming. 
            ¡Más de 100K seguidores ya lo hacen!
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <Button 
              size="lg" 
              className="btn-gaming px-8 py-4 text-lg group"
              onClick={() => window.open('https://tiktok.com/@gamefullz', '_blank')}
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
            <div>
              <div className="font-gaming text-2xl font-bold text-primary">500+</div>
              <div className="text-sm text-muted-foreground">Videos</div>
            </div>
            <div>
              <div className="font-gaming text-2xl font-bold text-secondary">2M+</div>
